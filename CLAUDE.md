...
sintbot 含两根支柱：① **多模型群聊机器人** —— 把 AI agent 接进飞书/Slack 群，cc-bot 是其中已上线的 Claude Code 版；② **桌宠** —— 趴桌面、**会说话、出声反应**、有性格的虚拟伙伴（注意口径：2026-07 起已从「演开发状态」改成「出声反应」，见提交 `7b0feba` / `1f4df31`，站上文案勿再往状态展示上写）。单页同时呈现这两部分。
